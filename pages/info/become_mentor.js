      ...
      <div className={styles.main_container}>
        <div>
          <h1 className={styles.title}>
            How to get started if you want to become a mentor ?
          </h1>
          <h2>
            Mentors have two methods to spread their knowledge and help mentees
            : Accept an existing mentoring request or creating a new mentoring
            opportunity
          </h2>
        </div>
        <div className={styles.sections}>
          <h1>Accepting an existing mentoring request</h1>
          <div>
            <h1>Step 1</h1>
          ...
          <div>
            <div>
              <h1>Creating a new mentoring opportunity</h1>
              <div>
                <h1>Step 1</h1>
                <h2>Creating an account or login</h2>
                <p>
